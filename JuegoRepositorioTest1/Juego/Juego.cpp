...
// Made global the window's proportions to use them in the functions <------ By Abecasis Alejandro
...
int main(int argc, char **argv) {
	...
	al_set_sample_instance_playmode(player.sndPlaDamagedInstance, ALLEGRO_PLAYMODE_ONCE);
	al_attach_sample_instance_to_mixer(player.sndPlaDamagedInstance, al_get_default_mixer());
	...
	al_set_sample_instance_playmode(bullet.sndShootInstance, ALLEGRO_PLAYMODE_ONCE);
	al_attach_sample_instance_to_mixer(bullet.sndShootInstance, al_get_default_mixer());
	...
	al_destroy_sample(bullet.sndShoot);
	al_destroy_sample(ambientMusic);

	al_destroy_sample_instance(player.sndPlaDamagedInstance);
	al_destroy_sample_instance(bullet.sndShootInstance);
